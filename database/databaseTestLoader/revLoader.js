...
writeReviews.write('reviewID|productID|reviewHeading|reviewText|reviewUserID|reviewRating|reviewRecommended|reviewHelpful|reviewUnhelpful|reviewQuality|reviewValue|reviewEaseOfUse|createdAt\n', 'utf8');
...
function writeTenMillionReviews(writer, encoding, callback) {
    ...
    function write() {
      ...
      do {
        ...
        const createdAt = moment(new Date(faker.date.recent(92))).format("LLLL");



        // const avatar = faker.image.avatar();
        const data = `${id}|${productID}|${reviewHeading}|${reviewText}|${reviewUserID}|${reviewRating}|${reviewRecommended}|${reviewHelpful}|${reviewUnhelpful}|${reviewQuality}|${reviewValue}|${reviewEaseOfUse}|${createdAt}\n`;
        if (i === 0) {
